      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8'>
        {animals.map(animal => (
          ...
          >
            ...
            <p className='text-gray-600 mb-2'><strong className='text-gray-900'>Species:</strong> {animal.species}</p>
            <p className='text-gray-600'><strong className='text-gray-900'>Age:</strong> {animal.age}</p>
          </div>
        ))}
      </div>
    </div>
